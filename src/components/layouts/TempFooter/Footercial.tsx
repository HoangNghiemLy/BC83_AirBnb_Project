      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm">
              Email: <span className="text-primary">airbnb@gmail.com</span>
            </p>
            <p className="uppercase text-xs mt-2 text-gray-500">
              {t("homepage.Footer.row1.customerServices")}
            </p>
            <p className="font-semibold text-primary">0982919123</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li
                  key={index}
                  className="flex items-center gap-2 cursor-pointer text-gray-700 hover:text-primary transition-colors"
          ...
          <div>
            <input
              type="text"
              placeholder="Email*"
              className="w-full p-2 mb-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary"
            />
            <button className="w-full bg-primary text-white py-2 rounded-md hover:opacity-80 transition-colors">
              Subscribe
            </button>

            <div className="flex gap-4 mt-5 text-xl text-primary">
        ...
        <div className="mt-12 border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
          <p>
            © 2025 <span className="text-primary font-bold">AIRBNB</span>. All
            Rights Reserved.
          </p>
